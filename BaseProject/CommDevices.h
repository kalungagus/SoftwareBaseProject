...
#pragma endregion
	...
	public ref class USBDevice : CommLayer
	{
		...
		public:
			...
			// Métodos
			//==================================================================================================
			// Retorna uma lista de portas COM virtuais que estão ligadas a um dispositivo Vizentec.
			static array<String ^>^ getUSBDevicesList(void)
			{
				...
				InterfaceIndex = 0;
				// Procura nas interfaces disponíveis aquelas que possuam o mesmo ID utilizado por dispositivos Vizentec.
